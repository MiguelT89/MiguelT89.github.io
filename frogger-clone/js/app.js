...
// var choice = document.addEventListener("click", function() {
//     document.getElementById("character").getAttribute("src");
// });
// choice.addEventListener("click", function() {
//     playerChoice = this.getAttribute("src");
// });
...
//     var promptChoice = prompt("Please enter the number (1-5) for the character you want to play.");
//     switch (promptChoice) {
//     case '1':
